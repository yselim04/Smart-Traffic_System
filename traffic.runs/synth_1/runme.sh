...
HD_PWD='C:/Users/lenovo/Desktop/traffic/traffic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_traffic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_traffic.tcl
