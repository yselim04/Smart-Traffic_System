...
HD_PWD='C:/Users/lenovo/Desktop/traffic/traffic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_traffic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_traffic.tcl -notrace
